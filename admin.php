<?php
        ...
        include 'conexion.php'; // Conexión a la base de datos
            ...
            // Consulta para obtener los campos que quieres mostrar
            $sql = "SELECT nombre, correo, estudios, situacion, experiencia, telefono, provincia, contra FROM visitantes";
...
<html>
    ...
    <body>
            ...
            <div class="caja ">
                ...
                <form action="modificar.php" class="formulario" method="post">
                    ...
                    if (!isset($_SESSION['idUsuario'])) {
                        ...
                        echo '<input type="text" name="nombre" id="" class="form-control mb-2" readonly>';
                        echo '<label for="" class="form-label">Correo</label>';
                        echo '<input type="text" name="correo" id="" class="form-control mb-2 readonly">';
                        echo '<label for="" class="form-label">Contraseña</label>';
                        echo '<input type="password" name="contra" id="" class="form-control mb-3" readonly>';
                    }else{
                        echo '<label for="nombre" class="form-label">Nombre</label>';
                        echo '<input type="text" name="nombre" id="" class="form-control mb-2" value="'.$nombre.'" readonly>';
                        echo '<label for="" class="form-label">Correo</label>';
                        echo '<input type="text" name="correo" id="" class="form-control mb-2" value="'.$correo.'" readonly>';
                        echo '<label for="" class="form-label">Contraseña</label>';
                        echo '<input type="password" name="contra" id="" class="form-control mb-3" value="'.$contra.'" readonly>';
                    }
                    ?>
        ...
        <h2 class="mb-3">Lista de Visitantes</h2>
